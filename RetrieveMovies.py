...
# ======================= DB variables =====================================================
    ...
    #ageRating = get_slots(intent_request)['ageRating']
...
# ========================================================================== PUT HERE ===============================================================================================
    ...
    #results = '*queryResults, sep = " ")'
    
    
    #scan_kwargs = {
    #    'FilterExpression': Key('Year').gt(movieYear) * Key(IMDb).gt
   # }
...
#    else:
 ...
 #   movie = get_movie("The Pianist", 2002,)
  #  if movie:
